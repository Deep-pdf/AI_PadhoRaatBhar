    ...
    return (
        <aside className="fixed left-0 top-0 h-full w-64 z-40 bg-[#0E0E0F] flex flex-col py-5 px-4 hidden lg:flex border-r border-[#4a4455]/20">
            ...
            <nav className="flex-1 space-y-1">
                ...
                <button onClick={() => setCurrentView('api_key')} className={`w-full flex items-center gap-3 px-4 py-2.5 transition-all rounded-lg group ${currentView === 'api_key' ? 'bg-[#201F20] text-[#d3bbff] shadow-[0_0_15px_rgba(109,40,217,0.3)]' : 'text-[#ccc3d7] opacity-70 hover:bg-[#2A2A2B] hover:opacity-100'}`}>
